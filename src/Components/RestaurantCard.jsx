...
const RestaurantCard = (props) => {
	...
	return (
		<div
			...
			<img
				src='https://res.cloudinary.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_660,h_366,c_fill/restaurant-default.png'
			...
			<p>Rating: {props.data.avgRating}</p>
			<p>Delivery Time: {props.data.deliveryTime} minutes</p>
		</div>
	)
}
